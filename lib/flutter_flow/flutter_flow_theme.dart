...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFB6E6BD);
  late Color secondary = const Color(0xFFA0E9A4);
  late Color tertiary = const Color(0xFF8AE1A2);
  late Color alternate = const Color(0xFF7BD4A2);
  ...
  late Color accent2 = const Color(0xFF4ECDC4);
  late Color accent3 = const Color(0xFFFF6B6B);
  late Color accent4 = const Color(0xFFC06C84);
  late Color success = const Color(0xFF77DD77);
  late Color warning = const Color(0xFFFFD700);
  late Color error = const Color(0xFFFF5733);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF64A883);
  late Color secondary = const Color(0xFF5AC174);
  late Color tertiary = const Color(0xFF4DCB73);
  late Color alternate = const Color(0xFF3EBB73);
