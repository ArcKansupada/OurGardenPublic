...
import 'my_requests_page_model.dart';
export 'my_requests_page_model.dart';

class MyRequestsPageWidget extends StatefulWidget {
  const MyRequestsPageWidget({super.key});

  @override
  State<MyRequestsPageWidget> createState() => _MyRequestsPageWidgetState();
}

class _MyRequestsPageWidgetState extends State<MyRequestsPageWidget> {
  late MyRequestsPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MyRequestsPageModel());
  }
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<CommunitiesRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CommunitiesRecord> myRequestsPageCommunitiesRecordList =
            snapshot.data!;
                      ...
                      builder: (context) => Builder(
                        builder: (context) {
                          final reqs = (_model.choiceChipsValue == 'Accepted'
                                  ? (currentUserDocument?.acceptedRequests
                                          .toList() ??
                                      [])
                                  : (currentUserDocument?.outgoingRequests
                                          .toList() ??
                                      []))
                              .toList();
